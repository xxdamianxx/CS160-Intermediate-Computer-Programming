...
public class ArrayListTest {
    ...
    public void shallowDeepCloneArrays() {
        ...
        ArrayList<Student> deepclonedStudents = (ArrayList<Student>) students.clone();
        for (Student e : students) {
            deepclonedStudents.add(e.clone());
        }

        clonedStudents = new ArrayList<>();

        ArrayList<Student> deepClonedStudents = new ArrayList<>();
        for (Student student : students) {
            deepClonedStudents.add(student.clone());
        }
        ...
        deepClonedStudents.get(1).setName("Jennifer Hanks");
        System.out.println("Student List");
    ...
    public void removeByValueFromArrayList() {
        ...
        while (it.hasNext()) {
            Student e = it.next();
            if (e.getRedId() % 2 == 0) { // Check for even redIds
                it.remove(); // Remove using the Iterator
            }
        }
